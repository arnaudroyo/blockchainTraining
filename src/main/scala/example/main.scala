...
object Main extends App {
  val walletManager = new EthereumWalletManager()
  walletManager.checkEthConnection()

  val privateKey = "xxx"
  val contractBinary = ""

  val contractAddress = walletManager.deployContract(privateKey, contractBinary)
  println(s"Contract deployed at address: $contractAddress")

  walletManager.callSetFunction(privateKey, contractAddress)
  val result = walletManager.callGetFunction(privateKey, contractAddress)
  println(s"Stored value: $result")
}